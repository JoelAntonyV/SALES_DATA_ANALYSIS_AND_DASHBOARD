# SALES_DATA_ANALYSIS_AND_DASHBOARD
A Data analysis project for Technova Retail Pvt. (2025) using Excel and power BI to identfy key sales  , insights and profitability.
